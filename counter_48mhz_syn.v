...
//lpm_counter DEVICE_FAMILY="Cyclone II" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=20 clock q sclr
...
`endif
	...
	wire  [19:0]   wire_counter_reg_bit1a_regout;
	wire  [19:0]   wire_counter_reg_bit1a_sdata;
	wire  aclr_actual;
	wire clk_en;
	wire cnt_en;
	wire [19:0]  data;
	...
	assign
		wire_counter_reg_bit1a_sdata = ({20{(~ sclr)}} & (({20{sset}} & s_val) | ({20{(~ sset)}} & data)));
	assign
		aclr_actual = 1'b0,
		clk_en = 1'b1,
		cnt_en = 1'b1,
...
module counter_48mhz (
	...
	counter_48mhz_cntr	counter_48mhz_cntr_component (
				.clock (clock),
				.sclr (sclr),
				.q (sub_wire0));
